...
public class Nidalee implements Parcelable
{
    ...
    public final static Creator<Nidalee> CREATOR = new Creator<Nidalee>() {


        public Nidalee createFromParcel(Parcel in) {
            Nidalee instance = new Nidalee();
        ...
        public Nidalee[] newArray(int size) {
            return (new Nidalee[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nidalee) == false) {
            return false;
        }
        Nidalee rhs = ((Nidalee) other);
