...
public class Vladimir implements Parcelable
{
    ...
    public final static Creator<Vladimir> CREATOR = new Creator<Vladimir>() {


        public Vladimir createFromParcel(Parcel in) {
            Vladimir instance = new Vladimir();
        ...
        public Vladimir[] newArray(int size) {
            return (new Vladimir[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vladimir) == false) {
            return false;
        }
        Vladimir rhs = ((Vladimir) other);
