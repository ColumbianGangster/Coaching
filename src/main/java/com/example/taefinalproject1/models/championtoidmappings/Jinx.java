...
public class Jinx implements Parcelable
{
    ...
    public final static Creator<Jinx> CREATOR = new Creator<Jinx>() {


        public Jinx createFromParcel(Parcel in) {
            Jinx instance = new Jinx();
        ...
        public Jinx[] newArray(int size) {
            return (new Jinx[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Jinx) == false) {
            return false;
        }
        Jinx rhs = ((Jinx) other);
