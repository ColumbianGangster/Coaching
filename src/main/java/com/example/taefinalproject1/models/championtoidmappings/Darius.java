...
public class Darius implements Parcelable
{
    ...
    public final static Creator<Darius> CREATOR = new Creator<Darius>() {


        public Darius createFromParcel(Parcel in) {
            Darius instance = new Darius();
        ...
        public Darius[] newArray(int size) {
            return (new Darius[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Darius) == false) {
            return false;
        }
        Darius rhs = ((Darius) other);
