...
public class Rumble implements Parcelable
{
    ...
    public final static Creator<Rumble> CREATOR = new Creator<Rumble>() {


        public Rumble createFromParcel(Parcel in) {
            Rumble instance = new Rumble();
        ...
        public Rumble[] newArray(int size) {
            return (new Rumble[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rumble) == false) {
            return false;
        }
        Rumble rhs = ((Rumble) other);
