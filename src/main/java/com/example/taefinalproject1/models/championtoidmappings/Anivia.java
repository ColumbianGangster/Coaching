...
public class Anivia implements Parcelable
{
    ...
    public final static Creator<Anivia> CREATOR = new Creator<Anivia>() {


        public Anivia createFromParcel(Parcel in) {
            Anivia instance = new Anivia();
        ...
        public Anivia[] newArray(int size) {
            return (new Anivia[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Anivia) == false) {
            return false;
        }
        Anivia rhs = ((Anivia) other);
