...
public class Viktor implements Parcelable
{
    ...
    public final static Creator<Viktor> CREATOR = new Creator<Viktor>() {


        public Viktor createFromParcel(Parcel in) {
            Viktor instance = new Viktor();
        ...
        public Viktor[] newArray(int size) {
            return (new Viktor[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Viktor) == false) {
            return false;
        }
        Viktor rhs = ((Viktor) other);
