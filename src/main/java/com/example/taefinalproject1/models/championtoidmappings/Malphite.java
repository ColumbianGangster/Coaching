...
public class Malphite implements Parcelable
{
    ...
    public final static Creator<Malphite> CREATOR = new Creator<Malphite>() {


        public Malphite createFromParcel(Parcel in) {
            Malphite instance = new Malphite();
        ...
        public Malphite[] newArray(int size) {
            return (new Malphite[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Malphite) == false) {
            return false;
        }
        Malphite rhs = ((Malphite) other);
