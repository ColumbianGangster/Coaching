...
public class JarvanIV implements Parcelable
{
    ...
    public final static Creator<JarvanIV> CREATOR = new Creator<JarvanIV>() {


        public JarvanIV createFromParcel(Parcel in) {
            JarvanIV instance = new JarvanIV();
        ...
        public JarvanIV[] newArray(int size) {
            return (new JarvanIV[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof JarvanIV) == false) {
            return false;
        }
        JarvanIV rhs = ((JarvanIV) other);
