...
public class Nasus implements Parcelable
{
    ...
    public final static Creator<Nasus> CREATOR = new Creator<Nasus>() {


        public Nasus createFromParcel(Parcel in) {
            Nasus instance = new Nasus();
        ...
        public Nasus[] newArray(int size) {
            return (new Nasus[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nasus) == false) {
            return false;
        }
        Nasus rhs = ((Nasus) other);
