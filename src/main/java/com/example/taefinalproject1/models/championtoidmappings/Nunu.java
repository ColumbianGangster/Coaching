...
public class Nunu implements Parcelable
{
    ...
    public final static Creator<Nunu> CREATOR = new Creator<Nunu>() {


        public Nunu createFromParcel(Parcel in) {
            Nunu instance = new Nunu();
        ...
        public Nunu[] newArray(int size) {
            return (new Nunu[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nunu) == false) {
            return false;
        }
        Nunu rhs = ((Nunu) other);
