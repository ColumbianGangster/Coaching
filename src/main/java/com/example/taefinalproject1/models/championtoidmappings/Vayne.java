...
public class Vayne implements Parcelable
{
    ...
    public final static Creator<Vayne> CREATOR = new Creator<Vayne>() {


        public Vayne createFromParcel(Parcel in) {
            Vayne instance = new Vayne();
        ...
        public Vayne[] newArray(int size) {
            return (new Vayne[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Vayne) == false) {
            return false;
        }
        Vayne rhs = ((Vayne) other);
