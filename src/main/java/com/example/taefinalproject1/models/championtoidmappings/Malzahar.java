...
public class Malzahar implements Parcelable
{
    ...
    public final static Creator<Malzahar> CREATOR = new Creator<Malzahar>() {


        public Malzahar createFromParcel(Parcel in) {
            Malzahar instance = new Malzahar();
        ...
        public Malzahar[] newArray(int size) {
            return (new Malzahar[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Malzahar) == false) {
            return false;
        }
        Malzahar rhs = ((Malzahar) other);
