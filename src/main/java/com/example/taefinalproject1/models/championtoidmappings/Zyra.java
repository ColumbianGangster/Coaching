...
public class Zyra implements Parcelable
{
    ...
    public final static Creator<Zyra> CREATOR = new Creator<Zyra>() {


        public Zyra createFromParcel(Parcel in) {
            Zyra instance = new Zyra();
        ...
        public Zyra[] newArray(int size) {
            return (new Zyra[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Zyra) == false) {
            return false;
        }
        Zyra rhs = ((Zyra) other);
