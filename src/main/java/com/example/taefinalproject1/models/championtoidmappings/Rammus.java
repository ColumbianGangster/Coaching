...
public class Rammus implements Parcelable
{
    ...
    public final static Creator<Rammus> CREATOR = new Creator<Rammus>() {


        public Rammus createFromParcel(Parcel in) {
            Rammus instance = new Rammus();
        ...
        public Rammus[] newArray(int size) {
            return (new Rammus[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rammus) == false) {
            return false;
        }
        Rammus rhs = ((Rammus) other);
