...
public class Xerath implements Parcelable
{
    ...
    public final static Creator<Xerath> CREATOR = new Creator<Xerath>() {


        public Xerath createFromParcel(Parcel in) {
            Xerath instance = new Xerath();
        ...
        public Xerath[] newArray(int size) {
            return (new Xerath[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xerath) == false) {
            return false;
        }
        Xerath rhs = ((Xerath) other);
