...
public class Ezreal implements Parcelable
{
    ...
    public final static Creator<Ezreal> CREATOR = new Creator<Ezreal>() {


        public Ezreal createFromParcel(Parcel in) {
            Ezreal instance = new Ezreal();
        ...
        public Ezreal[] newArray(int size) {
            return (new Ezreal[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ezreal) == false) {
            return false;
        }
        Ezreal rhs = ((Ezreal) other);
