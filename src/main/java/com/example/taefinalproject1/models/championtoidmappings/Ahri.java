...
public class Ahri implements Parcelable
{
    ...
    public final static Creator<Ahri> CREATOR = new Creator<Ahri>() {


        public Ahri createFromParcel(Parcel in) {
            Ahri instance = new Ahri();
        ...
        public Ahri[] newArray(int size) {
            return (new Ahri[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ahri) == false) {
            return false;
        }
        Ahri rhs = ((Ahri) other);
