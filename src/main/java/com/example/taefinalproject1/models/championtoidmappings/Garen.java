...
public class Garen implements Parcelable
{
    ...
    public final static Creator<Garen> CREATOR = new Creator<Garen>() {


        public Garen createFromParcel(Parcel in) {
            Garen instance = new Garen();
        ...
        public Garen[] newArray(int size) {
            return (new Garen[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Garen) == false) {
            return false;
        }
        Garen rhs = ((Garen) other);
