...
public class Kalista implements Parcelable
{
    ...
    public final static Creator<Kalista> CREATOR = new Creator<Kalista>() {


        public Kalista createFromParcel(Parcel in) {
            Kalista instance = new Kalista();
        ...
        public Kalista[] newArray(int size) {
            return (new Kalista[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kalista) == false) {
            return false;
        }
        Kalista rhs = ((Kalista) other);
