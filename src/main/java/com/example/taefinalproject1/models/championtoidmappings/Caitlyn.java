...
public class Caitlyn implements Parcelable
{
    ...
    public final static Creator<Caitlyn> CREATOR = new Creator<Caitlyn>() {


        public Caitlyn createFromParcel(Parcel in) {
            Caitlyn instance = new Caitlyn();
        ...
        public Caitlyn[] newArray(int size) {
            return (new Caitlyn[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Caitlyn) == false) {
            return false;
        }
        Caitlyn rhs = ((Caitlyn) other);
