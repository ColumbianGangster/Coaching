...
public class Nautilus implements Parcelable
{
    ...
    public final static Creator<Nautilus> CREATOR = new Creator<Nautilus>() {


        public Nautilus createFromParcel(Parcel in) {
            Nautilus instance = new Nautilus();
        ...
        public Nautilus[] newArray(int size) {
            return (new Nautilus[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nautilus) == false) {
            return false;
        }
        Nautilus rhs = ((Nautilus) other);
