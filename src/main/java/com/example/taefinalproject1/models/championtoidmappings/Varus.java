...
public class Varus implements Parcelable
{
    ...
    public final static Creator<Varus> CREATOR = new Creator<Varus>() {


        public Varus createFromParcel(Parcel in) {
            Varus instance = new Varus();
        ...
        public Varus[] newArray(int size) {
            return (new Varus[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Varus) == false) {
            return false;
        }
        Varus rhs = ((Varus) other);
