...
public class Sona implements Parcelable
{
    ...
    public final static Creator<Sona> CREATOR = new Creator<Sona>() {


        public Sona createFromParcel(Parcel in) {
        ...
        public Sona[] newArray(int size) {
            return (new Sona[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sona) == false) {
            return false;
        }
        Sona rhs = ((Sona) other);
