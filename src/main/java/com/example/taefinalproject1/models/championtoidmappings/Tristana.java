...
public class Tristana implements Parcelable
{
    ...
    public final static Creator<Tristana> CREATOR = new Creator<Tristana>() {


        public Tristana createFromParcel(Parcel in) {
            Tristana instance = new Tristana();
        ...
        public Tristana[] newArray(int size) {
            return (new Tristana[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tristana) == false) {
            return false;
        }
        Tristana rhs = ((Tristana) other);
