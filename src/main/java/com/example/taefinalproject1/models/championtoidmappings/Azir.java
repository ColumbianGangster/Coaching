...
public class Azir implements Parcelable
{
    ...
    public final static Creator<Azir> CREATOR = new Creator<Azir>() {


        public Azir createFromParcel(Parcel in) {
            Azir instance = new Azir();
        ...
        public Azir[] newArray(int size) {
            return (new Azir[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Azir) == false) {
            return false;
        }
        Azir rhs = ((Azir) other);
