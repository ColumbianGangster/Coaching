...
public class Teemo implements Parcelable
{
    ...
    public final static Creator<Teemo> CREATOR = new Creator<Teemo>() {


        public Teemo createFromParcel(Parcel in) {
            Teemo instance = new Teemo();
        ...
        public Teemo[] newArray(int size) {
            return (new Teemo[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Teemo) == false) {
            return false;
        }
        Teemo rhs = ((Teemo) other);
