...
public class Maokai implements Parcelable
{
    ...
    public final static Creator<Maokai> CREATOR = new Creator<Maokai>() {


        public Maokai createFromParcel(Parcel in) {
            Maokai instance = new Maokai();
        ...
        public Maokai[] newArray(int size) {
            return (new Maokai[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Maokai) == false) {
            return false;
        }
        Maokai rhs = ((Maokai) other);
