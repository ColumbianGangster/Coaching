...
public class Chogath implements Parcelable
{
    ...
    public final static Creator<Chogath> CREATOR = new Creator<Chogath>() {


        public Chogath createFromParcel(Parcel in) {
            Chogath instance = new Chogath();
        ...
        public Chogath[] newArray(int size) {
            return (new Chogath[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Chogath) == false) {
            return false;
        }
        Chogath rhs = ((Chogath) other);
