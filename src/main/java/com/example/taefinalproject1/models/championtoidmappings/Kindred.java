...
public class Kindred implements Parcelable
{
    ...
    public final static Creator<Kindred> CREATOR = new Creator<Kindred>() {


        public Kindred createFromParcel(Parcel in) {
            Kindred instance = new Kindred();
        ...
        public Kindred[] newArray(int size) {
            return (new Kindred[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kindred) == false) {
            return false;
        }
        Kindred rhs = ((Kindred) other);
