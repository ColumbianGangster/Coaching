...
public class Pantheon implements Parcelable
{
    ...
    public final static Creator<Pantheon> CREATOR = new Creator<Pantheon>() {


        public Pantheon createFromParcel(Parcel in) {
            Pantheon instance = new Pantheon();
        ...
        public Pantheon[] newArray(int size) {
            return (new Pantheon[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pantheon) == false) {
            return false;
        }
        Pantheon rhs = ((Pantheon) other);
