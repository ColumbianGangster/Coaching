...
public class Braum implements Parcelable
{
    ...
    public final static Creator<Braum> CREATOR = new Creator<Braum>() {


        public Braum createFromParcel(Parcel in) {
            Braum instance = new Braum();
        ...
        public Braum[] newArray(int size) {
            return (new Braum[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Braum) == false) {
            return false;
        }
        Braum rhs = ((Braum) other);
