...
public class Olaf implements Parcelable
{
    ...
    public final static Creator<Olaf> CREATOR = new Creator<Olaf>() {


        public Olaf createFromParcel(Parcel in) {
            Olaf instance = new Olaf();
        ...
        public Olaf[] newArray(int size) {
            return (new Olaf[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Olaf) == false) {
            return false;
        }
        Olaf rhs = ((Olaf) other);
