...
public class Swain implements Parcelable
{
    ...
    public final static Creator<Swain> CREATOR = new Creator<Swain>() {


        public Swain createFromParcel(Parcel in) {
            Swain instance = new Swain();
        ...
        public Swain[] newArray(int size) {
            return (new Swain[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Swain) == false) {
            return false;
        }
        Swain rhs = ((Swain) other);
