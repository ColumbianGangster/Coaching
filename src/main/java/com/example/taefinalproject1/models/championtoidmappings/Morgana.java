...
public class Morgana implements Parcelable
{
    ...
    public final static Creator<Morgana> CREATOR = new Creator<Morgana>() {


        public Morgana createFromParcel(Parcel in) {
            Morgana instance = new Morgana();
        ...
        public Morgana[] newArray(int size) {
            return (new Morgana[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Morgana) == false) {
            return false;
        }
        Morgana rhs = ((Morgana) other);
