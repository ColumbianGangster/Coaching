...
public class RekSai implements Parcelable
{
    ...
    public final static Creator<RekSai> CREATOR = new Creator<RekSai>() {


        public RekSai createFromParcel(Parcel in) {
            RekSai instance = new RekSai();
        ...
        public RekSai[] newArray(int size) {
            return (new RekSai[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RekSai) == false) {
            return false;
        }
        RekSai rhs = ((RekSai) other);
