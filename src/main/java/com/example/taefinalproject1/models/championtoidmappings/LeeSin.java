...
public class LeeSin implements Parcelable
{
    ...
    public final static Creator<LeeSin> CREATOR = new Creator<LeeSin>() {


        public LeeSin createFromParcel(Parcel in) {
            LeeSin instance = new LeeSin();
        ...
        public LeeSin[] newArray(int size) {
            return (new LeeSin[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LeeSin) == false) {
            return false;
        }
        LeeSin rhs = ((LeeSin) other);
