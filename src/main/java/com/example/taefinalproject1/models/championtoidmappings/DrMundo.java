...
public class DrMundo implements Parcelable
{
    ...
    public final static Creator<DrMundo> CREATOR = new Creator<DrMundo>() {


        public DrMundo createFromParcel(Parcel in) {
            DrMundo instance = new DrMundo();
        ...
        public DrMundo[] newArray(int size) {
            return (new DrMundo[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DrMundo) == false) {
            return false;
        }
        DrMundo rhs = ((DrMundo) other);
