...
public class Kayle implements Parcelable
{
    ...
    public final static Creator<Kayle> CREATOR = new Creator<Kayle>() {


        public Kayle createFromParcel(Parcel in) {
            Kayle instance = new Kayle();
        ...
        public Kayle[] newArray(int size) {
            return (new Kayle[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kayle) == false) {
            return false;
        }
        Kayle rhs = ((Kayle) other);
