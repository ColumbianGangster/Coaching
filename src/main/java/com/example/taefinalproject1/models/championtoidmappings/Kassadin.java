...
public class Kassadin implements Parcelable
{
    ...
    public final static Creator<Kassadin> CREATOR = new Creator<Kassadin>() {


        public Kassadin createFromParcel(Parcel in) {
            Kassadin instance = new Kassadin();
        ...
        public Kassadin[] newArray(int size) {
            return (new Kassadin[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kassadin) == false) {
            return false;
        }
        Kassadin rhs = ((Kassadin) other);
