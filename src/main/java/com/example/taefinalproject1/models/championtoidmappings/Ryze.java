...
public class Ryze implements Parcelable
{
    ...
    public final static Creator<Ryze> CREATOR = new Creator<Ryze>() {


        public Ryze createFromParcel(Parcel in) {
            Ryze instance = new Ryze();
        ...
        public Ryze[] newArray(int size) {
            return (new Ryze[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ryze) == false) {
            return false;
        }
        Ryze rhs = ((Ryze) other);
