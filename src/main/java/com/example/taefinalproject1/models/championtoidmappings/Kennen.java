...
public class Kennen implements Parcelable
{
    ...
    public final static Creator<Kennen> CREATOR = new Creator<Kennen>() {


        public Kennen createFromParcel(Parcel in) {
            Kennen instance = new Kennen();
        ...
        public Kennen[] newArray(int size) {
            return (new Kennen[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kennen) == false) {
            return false;
        }
        Kennen rhs = ((Kennen) other);
