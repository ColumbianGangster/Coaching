...
public class Singed implements Parcelable
{
    ...
    public final static Creator<Singed> CREATOR = new Creator<Singed>() {


        public Singed createFromParcel(Parcel in) {
            Singed instance = new Singed();
        ...
        public Singed[] newArray(int size) {
            return (new Singed[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Singed) == false) {
            return false;
        }
        Singed rhs = ((Singed) other);
