...
public class Leblanc implements Parcelable
{
    ...
    public final static Creator<Leblanc> CREATOR = new Creator<Leblanc>() {


        public Leblanc createFromParcel(Parcel in) {
            Leblanc instance = new Leblanc();
        ...
        public Leblanc[] newArray(int size) {
            return (new Leblanc[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Leblanc) == false) {
            return false;
        }
        Leblanc rhs = ((Leblanc) other);
