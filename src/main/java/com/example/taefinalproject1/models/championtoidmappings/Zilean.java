...
public class Zilean implements Parcelable
{
    ...
    public final static Creator<Zilean> CREATOR = new Creator<Zilean>() {


        public Zilean createFromParcel(Parcel in) {
            Zilean instance = new Zilean();
        ...
        public Zilean[] newArray(int size) {
            return (new Zilean[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Zilean) == false) {
            return false;
        }
        Zilean rhs = ((Zilean) other);
