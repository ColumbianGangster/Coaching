...
public class Akali implements Parcelable
{
    ...
    public final static Creator<Akali> CREATOR = new Creator<Akali>() {


        public Akali createFromParcel(Parcel in) {
            Akali instance = new Akali();
        ...
        public Akali[] newArray(int size) {
            return (new Akali[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Akali) == false) {
            return false;
        }
        Akali rhs = ((Akali) other);
