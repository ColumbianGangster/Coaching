...
public class Lulu implements Parcelable
{
    ...
    public final static Creator<Lulu> CREATOR = new Creator<Lulu>() {


        public Lulu createFromParcel(Parcel in) {
            Lulu instance = new Lulu();
        ...
        public Lulu[] newArray(int size) {
            return (new Lulu[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Lulu) == false) {
            return false;
        }
        Lulu rhs = ((Lulu) other);
