...
public class Twitch implements Parcelable
{
    ...
    public final static Creator<Twitch> CREATOR = new Creator<Twitch>() {


        public Twitch createFromParcel(Parcel in) {
        ...
        public Twitch[] newArray(int size) {
            return (new Twitch[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Twitch) == false) {
            return false;
        }
        Twitch rhs = ((Twitch) other);
