...
public class Fiora implements Parcelable
{
    ...
    public final static Creator<Fiora> CREATOR = new Creator<Fiora>() {


        public Fiora createFromParcel(Parcel in) {
            Fiora instance = new Fiora();
        ...
        public Fiora[] newArray(int size) {
            return (new Fiora[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fiora) == false) {
            return false;
        }
        Fiora rhs = ((Fiora) other);
