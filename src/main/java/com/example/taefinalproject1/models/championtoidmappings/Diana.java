...
public class Diana implements Parcelable
{
    ...
    public final static Creator<Diana> CREATOR = new Creator<Diana>() {


        public Diana createFromParcel(Parcel in) {
            Diana instance = new Diana();
        ...
        public Diana[] newArray(int size) {
            return (new Diana[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Diana) == false) {
            return false;
        }
        Diana rhs = ((Diana) other);
