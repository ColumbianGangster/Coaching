...
public class Renekton implements Parcelable
{
    ...
    public final static Creator<Renekton> CREATOR = new Creator<Renekton>() {


        public Renekton createFromParcel(Parcel in) {
            Renekton instance = new Renekton();
        ...
        public Renekton[] newArray(int size) {
            return (new Renekton[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Renekton) == false) {
            return false;
        }
        Renekton rhs = ((Renekton) other);
