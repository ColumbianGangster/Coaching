...
public class Skarner implements Parcelable
{
    ...
    public final static Creator<Skarner> CREATOR = new Creator<Skarner>() {


        public Skarner createFromParcel(Parcel in) {
            Skarner instance = new Skarner();
        ...
        public Skarner[] newArray(int size) {
            return (new Skarner[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Skarner) == false) {
            return false;
        }
        Skarner rhs = ((Skarner) other);
