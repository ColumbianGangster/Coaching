...
public class Jayce implements Parcelable
{
    ...
    public final static Creator<Jayce> CREATOR = new Creator<Jayce>() {


        public Jayce createFromParcel(Parcel in) {
            Jayce instance = new Jayce();
        ...
        public Jayce[] newArray(int size) {
            return (new Jayce[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Jayce) == false) {
            return false;
        }
        Jayce rhs = ((Jayce) other);
