...
public class Zac implements Parcelable
{
    ...
    public final static Creator<Zac> CREATOR = new Creator<Zac>() {


        public Zac createFromParcel(Parcel in) {
            Zac instance = new Zac();
