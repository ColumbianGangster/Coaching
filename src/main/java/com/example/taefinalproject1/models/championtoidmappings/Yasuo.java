...
public class Yasuo implements Parcelable
{
    ...
    public final static Creator<Yasuo> CREATOR = new Creator<Yasuo>() {


        public Yasuo createFromParcel(Parcel in) {
            Yasuo instance = new Yasuo();
        ...
        public Yasuo[] newArray(int size) {
            return (new Yasuo[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Yasuo) == false) {
            return false;
        }
        Yasuo rhs = ((Yasuo) other);
