...
public class Thresh implements Parcelable
{
    ...
    public final static Creator<Thresh> CREATOR = new Creator<Thresh>() {


        public Thresh createFromParcel(Parcel in) {
            Thresh instance = new Thresh();
        ...
        public Thresh[] newArray(int size) {
            return (new Thresh[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Thresh) == false) {
            return false;
        }
        Thresh rhs = ((Thresh) other);
