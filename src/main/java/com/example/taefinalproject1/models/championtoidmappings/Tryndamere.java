...
public class Tryndamere implements Parcelable
{
    ...
    public final static Creator<Tryndamere> CREATOR = new Creator<Tryndamere>() {


        public Tryndamere createFromParcel(Parcel in) {
            Tryndamere instance = new Tryndamere();
        ...
        public Tryndamere[] newArray(int size) {
            return (new Tryndamere[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tryndamere) == false) {
            return false;
        }
        Tryndamere rhs = ((Tryndamere) other);
