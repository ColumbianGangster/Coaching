...
public class Bard implements Parcelable
{
    ...
    public final static Creator<Bard> CREATOR = new Creator<Bard>() {


        public Bard createFromParcel(Parcel in) {
        ...
        public Bard[] newArray(int size) {
            return (new Bard[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bard) == false) {
            return false;
        }
        Bard rhs = ((Bard) other);
