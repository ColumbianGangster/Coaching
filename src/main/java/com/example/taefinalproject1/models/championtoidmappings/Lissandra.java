...
public class Lissandra implements Parcelable
{
    ...
    public final static Creator<Lissandra> CREATOR = new Creator<Lissandra>() {


        public Lissandra createFromParcel(Parcel in) {
            Lissandra instance = new Lissandra();
        ...
        public Lissandra[] newArray(int size) {
            return (new Lissandra[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Lissandra) == false) {
            return false;
        }
        Lissandra rhs = ((Lissandra) other);
