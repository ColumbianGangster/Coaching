...
public class Gragas implements Parcelable
{
    ...
    public final static Creator<Gragas> CREATOR = new Creator<Gragas>() {


        public Gragas createFromParcel(Parcel in) {
            Gragas instance = new Gragas();
        ...
        public Gragas[] newArray(int size) {
            return (new Gragas[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gragas) == false) {
            return false;
        }
        Gragas rhs = ((Gragas) other);
