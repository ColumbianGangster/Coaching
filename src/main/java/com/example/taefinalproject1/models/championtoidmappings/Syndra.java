...
public class Syndra implements Parcelable
{
    ...
    public final static Creator<Syndra> CREATOR = new Creator<Syndra>() {


        public Syndra createFromParcel(Parcel in) {
            Syndra instance = new Syndra();
        ...
        public Syndra[] newArray(int size) {
            return (new Syndra[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Syndra) == false) {
            return false;
        }
        Syndra rhs = ((Syndra) other);
