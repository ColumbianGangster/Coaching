...
public class Shaco implements Parcelable
{
    ...
    public final static Creator<Shaco> CREATOR = new Creator<Shaco>() {


        public Shaco createFromParcel(Parcel in) {
            Shaco instance = new Shaco();
        ...
        public Shaco[] newArray(int size) {
            return (new Shaco[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shaco) == false) {
            return false;
        }
        Shaco rhs = ((Shaco) other);
