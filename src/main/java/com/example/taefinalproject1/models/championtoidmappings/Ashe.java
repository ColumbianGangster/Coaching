...
public class Ashe implements Parcelable
{
    ...
    public final static Creator<Ashe> CREATOR = new Creator<Ashe>() {


        public Ashe createFromParcel(Parcel in) {
            Ashe instance = new Ashe();
        ...
        public Ashe[] newArray(int size) {
            return (new Ashe[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ashe) == false) {
            return false;
        }
        Ashe rhs = ((Ashe) other);
