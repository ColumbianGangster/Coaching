...
public class Draven implements Parcelable
{
    ...
    public final static Creator<Draven> CREATOR = new Creator<Draven>() {


        public Draven createFromParcel(Parcel in) {
            Draven instance = new Draven();
        ...
        public Draven[] newArray(int size) {
            return (new Draven[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Draven) == false) {
            return false;
        }
        Draven rhs = ((Draven) other);
