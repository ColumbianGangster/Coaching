...
public class Katarina implements Parcelable
{
    ...
    public final static Creator<Katarina> CREATOR = new Creator<Katarina>() {


        public Katarina createFromParcel(Parcel in) {
            Katarina instance = new Katarina();
        ...
        public Katarina[] newArray(int size) {
            return (new Katarina[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Katarina) == false) {
            return false;
        }
        Katarina rhs = ((Katarina) other);
