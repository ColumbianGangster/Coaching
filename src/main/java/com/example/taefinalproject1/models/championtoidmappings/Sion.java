...
public class Sion implements Parcelable
{
    ...
    public final static Creator<Sion> CREATOR = new Creator<Sion>() {


        public Sion createFromParcel(Parcel in) {
            Sion instance = new Sion();
        ...
        public Sion[] newArray(int size) {
            return (new Sion[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sion) == false) {
            return false;
        }
        Sion rhs = ((Sion) other);
