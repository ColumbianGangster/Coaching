...
public class Aatrox implements Parcelable
{
    ...
    public final static Creator<Aatrox> CREATOR = new Creator<Aatrox>() {


        public Aatrox createFromParcel(Parcel in) {
            Aatrox instance = new Aatrox();
        ...
        public Aatrox[] newArray(int size) {
            return (new Aatrox[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Aatrox) == false) {
            return false;
        }
        Aatrox rhs = ((Aatrox) other);
