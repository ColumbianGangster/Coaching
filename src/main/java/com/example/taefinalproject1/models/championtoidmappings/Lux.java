...
public class Lux implements Parcelable
{
    ...
    public final static Creator<Lux> CREATOR = new Creator<Lux>() {


        public Lux createFromParcel(Parcel in) {
            Lux instance = new Lux();
