...
public class Orianna implements Parcelable
{
    ...
    public final static Creator<Orianna> CREATOR = new Creator<Orianna>() {


        public Orianna createFromParcel(Parcel in) {
            Orianna instance = new Orianna();
        ...
        public Orianna[] newArray(int size) {
            return (new Orianna[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Orianna) == false) {
            return false;
        }
        Orianna rhs = ((Orianna) other);
