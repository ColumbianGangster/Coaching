...
public class Velkoz implements Parcelable
{
    ...
    public final static Creator<Velkoz> CREATOR = new Creator<Velkoz>() {


        public Velkoz createFromParcel(Parcel in) {
            Velkoz instance = new Velkoz();
        ...
        public Velkoz[] newArray(int size) {
            return (new Velkoz[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Velkoz) == false) {
            return false;
        }
        Velkoz rhs = ((Velkoz) other);
