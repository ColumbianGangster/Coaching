...
public class Fizz implements Parcelable
{
    ...
    public final static Creator<Fizz> CREATOR = new Creator<Fizz>() {


        public Fizz createFromParcel(Parcel in) {
            Fizz instance = new Fizz();
        ...
        public Fizz[] newArray(int size) {
            return (new Fizz[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fizz) == false) {
            return false;
        }
        Fizz rhs = ((Fizz) other);
