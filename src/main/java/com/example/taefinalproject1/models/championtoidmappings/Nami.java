...
public class Nami implements Parcelable
{
    ...
    public final static Creator<Nami> CREATOR = new Creator<Nami>() {


        public Nami createFromParcel(Parcel in) {
        ...
        public Nami[] newArray(int size) {
            return (new Nami[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nami) == false) {
            return false;
        }
        Nami rhs = ((Nami) other);
