...
public class Yorick implements Parcelable
{
    ...
    public final static Creator<Yorick> CREATOR = new Creator<Yorick>() {


        public Yorick createFromParcel(Parcel in) {
            Yorick instance = new Yorick();
        ...
        public Yorick[] newArray(int size) {
            return (new Yorick[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Yorick) == false) {
            return false;
        }
        Yorick rhs = ((Yorick) other);
