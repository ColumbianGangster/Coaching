...
public class XinZhao implements Parcelable
{
    ...
    public final static Creator<XinZhao> CREATOR = new Creator<XinZhao>() {


        public XinZhao createFromParcel(Parcel in) {
            XinZhao instance = new XinZhao();
        ...
        public XinZhao[] newArray(int size) {
            return (new XinZhao[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof XinZhao) == false) {
            return false;
        }
        XinZhao rhs = ((XinZhao) other);
