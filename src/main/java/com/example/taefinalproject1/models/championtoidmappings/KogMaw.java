...
public class KogMaw implements Parcelable
{
    ...
    public final static Creator<KogMaw> CREATOR = new Creator<KogMaw>() {


        public KogMaw createFromParcel(Parcel in) {
            KogMaw instance = new KogMaw();
        ...
        public KogMaw[] newArray(int size) {
            return (new KogMaw[size]);
        }
