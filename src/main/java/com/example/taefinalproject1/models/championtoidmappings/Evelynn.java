...
public class Evelynn implements Parcelable
{
    ...
    public final static Creator<Evelynn> CREATOR = new Creator<Evelynn>() {


        public Evelynn createFromParcel(Parcel in) {
            Evelynn instance = new Evelynn();
        ...
        public Evelynn[] newArray(int size) {
            return (new Evelynn[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Evelynn) == false) {
            return false;
        }
        Evelynn rhs = ((Evelynn) other);
