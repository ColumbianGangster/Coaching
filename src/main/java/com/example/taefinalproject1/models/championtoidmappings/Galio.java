...
public class Galio implements Parcelable
{
    ...
    public final static Creator<Galio> CREATOR = new Creator<Galio>() {


        public Galio createFromParcel(Parcel in) {
            Galio instance = new Galio();
        ...
        public Galio[] newArray(int size) {
            return (new Galio[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Galio) == false) {
            return false;
        }
        Galio rhs = ((Galio) other);
