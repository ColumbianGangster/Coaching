...
public class Poppy implements Parcelable
{
    ...
    public final static Creator<Poppy> CREATOR = new Creator<Poppy>() {


        public Poppy createFromParcel(Parcel in) {
            Poppy instance = new Poppy();
        ...
        public Poppy[] newArray(int size) {
            return (new Poppy[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Poppy) == false) {
            return false;
        }
        Poppy rhs = ((Poppy) other);
