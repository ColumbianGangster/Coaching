...
public class Quinn implements Parcelable
{
    ...
    public final static Creator<Quinn> CREATOR = new Creator<Quinn>() {


        public Quinn createFromParcel(Parcel in) {
            Quinn instance = new Quinn();
        ...
        public Quinn[] newArray(int size) {
            return (new Quinn[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Quinn) == false) {
            return false;
        }
        Quinn rhs = ((Quinn) other);
