...
public class MonkeyKing implements Parcelable
{
    ...
    public final static Creator<MonkeyKing> CREATOR = new Creator<MonkeyKing>() {


        public MonkeyKing createFromParcel(Parcel in) {
            MonkeyKing instance = new MonkeyKing();
        ...
        public MonkeyKing[] newArray(int size) {
            return (new MonkeyKing[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MonkeyKing) == false) {
            return false;
        }
        MonkeyKing rhs = ((MonkeyKing) other);
