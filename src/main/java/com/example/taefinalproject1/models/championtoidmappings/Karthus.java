...
public class Karthus implements Parcelable
{
    ...
    public final static Creator<Karthus> CREATOR = new Creator<Karthus>() {


        public Karthus createFromParcel(Parcel in) {
            Karthus instance = new Karthus();
        ...
        public Karthus[] newArray(int size) {
            return (new Karthus[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Karthus) == false) {
            return false;
        }
        Karthus rhs = ((Karthus) other);
