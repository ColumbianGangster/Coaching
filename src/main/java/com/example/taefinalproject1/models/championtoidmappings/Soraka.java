...
public class Soraka implements Parcelable
{
    ...
    public final static Creator<Soraka> CREATOR = new Creator<Soraka>() {


        public Soraka createFromParcel(Parcel in) {
            Soraka instance = new Soraka();
        ...
        public Soraka[] newArray(int size) {
            return (new Soraka[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Soraka) == false) {
            return false;
        }
        Soraka rhs = ((Soraka) other);
