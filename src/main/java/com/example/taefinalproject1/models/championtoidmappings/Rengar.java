...
public class Rengar implements Parcelable
{
    ...
    public final static Creator<Rengar> CREATOR = new Creator<Rengar>() {


        public Rengar createFromParcel(Parcel in) {
            Rengar instance = new Rengar();
        ...
        public Rengar[] newArray(int size) {
            return (new Rengar[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rengar) == false) {
            return false;
        }
        Rengar rhs = ((Rengar) other);
