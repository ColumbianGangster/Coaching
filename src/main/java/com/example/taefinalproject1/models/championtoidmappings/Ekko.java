...
public class Ekko implements Parcelable
{
    ...
    public final static Creator<Ekko> CREATOR = new Creator<Ekko>() {


        public Ekko createFromParcel(Parcel in) {
        ...
        public Ekko[] newArray(int size) {
            return (new Ekko[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ekko) == false) {
            return false;
        }
        Ekko rhs = ((Ekko) other);
