...
public class TahmKench implements Parcelable
{
    ...
    public final static Creator<TahmKench> CREATOR = new Creator<TahmKench>() {


        public TahmKench createFromParcel(Parcel in) {
            TahmKench instance = new TahmKench();
        ...
        public TahmKench[] newArray(int size) {
            return (new TahmKench[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TahmKench) == false) {
            return false;
        }
        TahmKench rhs = ((TahmKench) other);
