...
public class Elise implements Parcelable
{
    ...
    public final static Creator<Elise> CREATOR = new Creator<Elise>() {


        public Elise createFromParcel(Parcel in) {
            Elise instance = new Elise();
        ...
        public Elise[] newArray(int size) {
            return (new Elise[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Elise) == false) {
            return false;
        }
        Elise rhs = ((Elise) other);
