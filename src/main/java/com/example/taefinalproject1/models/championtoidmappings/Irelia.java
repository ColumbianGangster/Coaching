...
public class Irelia implements Parcelable
{
    ...
    public final static Creator<Irelia> CREATOR = new Creator<Irelia>() {


        public Irelia createFromParcel(Parcel in) {
            Irelia instance = new Irelia();
        ...
        public Irelia[] newArray(int size) {
            return (new Irelia[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Irelia) == false) {
            return false;
        }
        Irelia rhs = ((Irelia) other);
