...
public class Riven implements Parcelable
{
    ...
    public final static Creator<Riven> CREATOR = new Creator<Riven>() {


        public Riven createFromParcel(Parcel in) {
            Riven instance = new Riven();
        ...
        public Riven[] newArray(int size) {
            return (new Riven[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Riven) == false) {
            return false;
        }
        Riven rhs = ((Riven) other);
