...
public class MasterYi implements Parcelable
{
    ...
    public final static Creator<MasterYi> CREATOR = new Creator<MasterYi>() {


        public MasterYi createFromParcel(Parcel in) {
            MasterYi instance = new MasterYi();
        ...
        public MasterYi[] newArray(int size) {
            return (new MasterYi[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MasterYi) == false) {
            return false;
        }
        MasterYi rhs = ((MasterYi) other);
