...
public class Udyr implements Parcelable
{
    ...
    public final static Creator<Udyr> CREATOR = new Creator<Udyr>() {


        public Udyr createFromParcel(Parcel in) {
            Udyr instance = new Udyr();
        ...
        public Udyr[] newArray(int size) {
            return (new Udyr[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Udyr) == false) {
            return false;
        }
        Udyr rhs = ((Udyr) other);
