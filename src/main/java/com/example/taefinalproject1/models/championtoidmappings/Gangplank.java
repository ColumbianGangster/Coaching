...
public class Gangplank implements Parcelable
{
    ...
    public final static Creator<Gangplank> CREATOR = new Creator<Gangplank>() {


        public Gangplank createFromParcel(Parcel in) {
            Gangplank instance = new Gangplank();
        ...
        public Gangplank[] newArray(int size) {
            return (new Gangplank[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gangplank) == false) {
            return false;
        }
        Gangplank rhs = ((Gangplank) other);
