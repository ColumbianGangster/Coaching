...
public class Graves implements Parcelable
{
    ...
    public final static Creator<Graves> CREATOR = new Creator<Graves>() {


        public Graves createFromParcel(Parcel in) {
            Graves instance = new Graves();
        ...
        public Graves[] newArray(int size) {
            return (new Graves[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Graves) == false) {
            return false;
        }
        Graves rhs = ((Graves) other);
