...
public class Blitzcrank implements Parcelable
{
    ...
    public final static Creator<Blitzcrank> CREATOR = new Creator<Blitzcrank>() {


        public Blitzcrank createFromParcel(Parcel in) {
            Blitzcrank instance = new Blitzcrank();
        ...
        public Blitzcrank[] newArray(int size) {
            return (new Blitzcrank[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Blitzcrank) == false) {
            return false;
        }
        Blitzcrank rhs = ((Blitzcrank) other);
