...
public class Cassiopeia implements Parcelable
{
    ...
    public final static Creator<Cassiopeia> CREATOR = new Creator<Cassiopeia>() {


        public Cassiopeia createFromParcel(Parcel in) {
            Cassiopeia instance = new Cassiopeia();
        ...
        public Cassiopeia[] newArray(int size) {
            return (new Cassiopeia[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cassiopeia) == false) {
            return false;
        }
        Cassiopeia rhs = ((Cassiopeia) other);
