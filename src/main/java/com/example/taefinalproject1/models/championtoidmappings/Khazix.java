...
public class Khazix implements Parcelable
{
    ...
    public final static Creator<Khazix> CREATOR = new Creator<Khazix>() {


        public Khazix createFromParcel(Parcel in) {
            Khazix instance = new Khazix();
        ...
        public Khazix[] newArray(int size) {
            return (new Khazix[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Khazix) == false) {
            return false;
        }
        Khazix rhs = ((Khazix) other);
