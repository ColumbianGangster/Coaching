...
public class Alistar implements Parcelable
{
    ...
    public final static Creator<Alistar> CREATOR = new Creator<Alistar>() {


        public Alistar createFromParcel(Parcel in) {
            Alistar instance = new Alistar();
        ...
        public Alistar[] newArray(int size) {
            return (new Alistar[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Alistar) == false) {
            return false;
        }
        Alistar rhs = ((Alistar) other);
