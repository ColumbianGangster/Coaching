...
public class Illaoi implements Parcelable
{
    ...
    public final static Creator<Illaoi> CREATOR = new Creator<Illaoi>() {


        public Illaoi createFromParcel(Parcel in) {
            Illaoi instance = new Illaoi();
        ...
        public Illaoi[] newArray(int size) {
            return (new Illaoi[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Illaoi) == false) {
            return false;
        }
        Illaoi rhs = ((Illaoi) other);
