...
public class Jax implements Parcelable
{
    ...
    public final static Creator<Jax> CREATOR = new Creator<Jax>() {


        public Jax createFromParcel(Parcel in) {
            Jax instance = new Jax();
