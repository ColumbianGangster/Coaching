...
public class Sivir implements Parcelable
{
    ...
    public final static Creator<Sivir> CREATOR = new Creator<Sivir>() {


        public Sivir createFromParcel(Parcel in) {
            Sivir instance = new Sivir();
        ...
        public Sivir[] newArray(int size) {
            return (new Sivir[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sivir) == false) {
            return false;
        }
        Sivir rhs = ((Sivir) other);
