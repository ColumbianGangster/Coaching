...
public class Trundle implements Parcelable
{
    ...
    public final static Creator<Trundle> CREATOR = new Creator<Trundle>() {


        public Trundle createFromParcel(Parcel in) {
            Trundle instance = new Trundle();
        ...
        public Trundle[] newArray(int size) {
            return (new Trundle[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Trundle) == false) {
            return false;
        }
        Trundle rhs = ((Trundle) other);
