...
public class Ziggs implements Parcelable
{
    ...
    public final static Creator<Ziggs> CREATOR = new Creator<Ziggs>() {


        public Ziggs createFromParcel(Parcel in) {
            Ziggs instance = new Ziggs();
        ...
        public Ziggs[] newArray(int size) {
            return (new Ziggs[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ziggs) == false) {
            return false;
        }
        Ziggs rhs = ((Ziggs) other);
