...
public class Hecarim implements Parcelable
{
    ...
    public final static Creator<Hecarim> CREATOR = new Creator<Hecarim>() {


        public Hecarim createFromParcel(Parcel in) {
            Hecarim instance = new Hecarim();
        ...
        public Hecarim[] newArray(int size) {
            return (new Hecarim[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Hecarim) == false) {
            return false;
        }
        Hecarim rhs = ((Hecarim) other);
