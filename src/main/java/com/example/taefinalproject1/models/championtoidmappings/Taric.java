...
public class Taric implements Parcelable
{
    ...
    public final static Creator<Taric> CREATOR = new Creator<Taric>() {


        public Taric createFromParcel(Parcel in) {
            Taric instance = new Taric();
        ...
        public Taric[] newArray(int size) {
            return (new Taric[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Taric) == false) {
            return false;
        }
        Taric rhs = ((Taric) other);
