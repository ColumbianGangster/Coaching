...
public class Janna implements Parcelable
{
    ...
    public final static Creator<Janna> CREATOR = new Creator<Janna>() {


        public Janna createFromParcel(Parcel in) {
            Janna instance = new Janna();
        ...
        public Janna[] newArray(int size) {
            return (new Janna[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Janna) == false) {
            return false;
        }
        Janna rhs = ((Janna) other);
