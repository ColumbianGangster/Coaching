...
public class Lucian implements Parcelable
{
    ...
    public final static Creator<Lucian> CREATOR = new Creator<Lucian>() {


        public Lucian createFromParcel(Parcel in) {
            Lucian instance = new Lucian();
        ...
        public Lucian[] newArray(int size) {
            return (new Lucian[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Lucian) == false) {
            return false;
        }
        Lucian rhs = ((Lucian) other);
