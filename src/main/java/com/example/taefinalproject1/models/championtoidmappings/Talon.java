...
public class Talon implements Parcelable
{
    ...
    public final static Creator<Talon> CREATOR = new Creator<Talon>() {


        public Talon createFromParcel(Parcel in) {
            Talon instance = new Talon();
        ...
        public Talon[] newArray(int size) {
            return (new Talon[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Talon) == false) {
            return false;
        }
        Talon rhs = ((Talon) other);
