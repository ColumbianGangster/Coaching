...
public class Shyvana implements Parcelable
{
    ...
    public final static Creator<Shyvana> CREATOR = new Creator<Shyvana>() {


        public Shyvana createFromParcel(Parcel in) {
            Shyvana instance = new Shyvana();
        ...
        public Shyvana[] newArray(int size) {
            return (new Shyvana[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shyvana) == false) {
            return false;
        }
        Shyvana rhs = ((Shyvana) other);
