...
public class Leona implements Parcelable
{
    ...
    public final static Creator<Leona> CREATOR = new Creator<Leona>() {


        public Leona createFromParcel(Parcel in) {
            Leona instance = new Leona();
        ...
        public Leona[] newArray(int size) {
            return (new Leona[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Leona) == false) {
            return false;
        }
        Leona rhs = ((Leona) other);
