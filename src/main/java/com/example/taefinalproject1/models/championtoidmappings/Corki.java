...
public class Corki implements Parcelable
{
    ...
    public final static Creator<Corki> CREATOR = new Creator<Corki>() {


        public Corki createFromParcel(Parcel in) {
            Corki instance = new Corki();
        ...
        public Corki[] newArray(int size) {
            return (new Corki[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Corki) == false) {
            return false;
        }
        Corki rhs = ((Corki) other);
