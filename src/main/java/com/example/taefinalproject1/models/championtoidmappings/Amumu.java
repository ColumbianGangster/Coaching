...
public class Amumu implements Parcelable
{
    ...
    public final static Creator<Amumu> CREATOR = new Creator<Amumu>() {


        public Amumu createFromParcel(Parcel in) {
            Amumu instance = new Amumu();
        ...
        public Amumu[] newArray(int size) {
            return (new Amumu[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Amumu) == false) {
            return false;
        }
        Amumu rhs = ((Amumu) other);
