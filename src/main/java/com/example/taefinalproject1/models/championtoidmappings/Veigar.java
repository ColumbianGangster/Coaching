...
public class Veigar implements Parcelable
{
    ...
    public final static Creator<Veigar> CREATOR = new Creator<Veigar>() {


        public Veigar createFromParcel(Parcel in) {
            Veigar instance = new Veigar();
        ...
        public Veigar[] newArray(int size) {
            return (new Veigar[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Veigar) == false) {
            return false;
        }
        Veigar rhs = ((Veigar) other);
