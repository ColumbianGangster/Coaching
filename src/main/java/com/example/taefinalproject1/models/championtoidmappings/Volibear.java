...
public class Volibear implements Parcelable
{
    ...
    public final static Creator<Volibear> CREATOR = new Creator<Volibear>() {


        public Volibear createFromParcel(Parcel in) {
            Volibear instance = new Volibear();
        ...
        public Volibear[] newArray(int size) {
            return (new Volibear[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Volibear) == false) {
            return false;
        }
        Volibear rhs = ((Volibear) other);
