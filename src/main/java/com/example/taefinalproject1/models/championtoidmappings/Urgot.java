...
public class Urgot implements Parcelable
{
    ...
    public final static Creator<Urgot> CREATOR = new Creator<Urgot>() {


        public Urgot createFromParcel(Parcel in) {
            Urgot instance = new Urgot();
        ...
        public Urgot[] newArray(int size) {
            return (new Urgot[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Urgot) == false) {
            return false;
        }
        Urgot rhs = ((Urgot) other);
