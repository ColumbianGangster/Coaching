...
public class Shen implements Parcelable
{
    ...
    public final static Creator<Shen> CREATOR = new Creator<Shen>() {


        public Shen createFromParcel(Parcel in) {
            Shen instance = new Shen();
        ...
        public Shen[] newArray(int size) {
            return (new Shen[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shen) == false) {
            return false;
        }
        Shen rhs = ((Shen) other);
