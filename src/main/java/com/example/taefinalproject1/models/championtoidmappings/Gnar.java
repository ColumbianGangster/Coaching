...
public class Gnar implements Parcelable
{
    ...
    public final static Creator<Gnar> CREATOR = new Creator<Gnar>() {


        public Gnar createFromParcel(Parcel in) {
            Gnar instance = new Gnar();
        ...
        public Gnar[] newArray(int size) {
            return (new Gnar[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gnar) == false) {
            return false;
        }
        Gnar rhs = ((Gnar) other);
