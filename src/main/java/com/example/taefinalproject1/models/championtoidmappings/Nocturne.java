...
public class Nocturne implements Parcelable
{
    ...
    public final static Creator<Nocturne> CREATOR = new Creator<Nocturne>() {


        public Nocturne createFromParcel(Parcel in) {
            Nocturne instance = new Nocturne();
        ...
        public Nocturne[] newArray(int size) {
            return (new Nocturne[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nocturne) == false) {
            return false;
        }
        Nocturne rhs = ((Nocturne) other);
